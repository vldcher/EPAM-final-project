...
gulp.task('watch', ['sass', 'js', 'browser-sync'], function() {
	...
	gulp.watch(['libs/**/*.js', 'app/js/common.js', 'app/js/gallery.js', 'app/js/slider.js', 'app/js/pagination.js', 'app/js/modal-window.js', 'app/js/reservation.js', 'app/js/check-reservation.js' ], ['js'], browserSync.reload);
